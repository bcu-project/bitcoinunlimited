The following is a list of assets used in the bitcoinunlimited source and their proper attribution.
...
### Info
* Designer: md2k7
* Site: https://bitcoinunlimitedtalk.org/index.php?topic=15276.0
...
### Info
* Designer: Jonas Schnelli (based on the original bitcoinunlimited logo from Bitboy)
* License: MIT
